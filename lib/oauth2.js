...
exports.OAuth2= function(clientId, clientSecret, baseSite, authorizePath, accessTokenPath, customHeaders, tunnelproxy) {
...
exports.OAuth2.prototype._request= function(method, url, headers, post_body, access_token, callback) {
  ...
  if (this._tunnelproxy.proxy) {
    ...
    options.agent = tunnelingAgentFn(this._tunnelproxy);
  }
